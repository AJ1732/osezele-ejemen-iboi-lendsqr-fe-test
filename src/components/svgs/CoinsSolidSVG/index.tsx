...
const CoinsSoliSVG: React.FC<SvgProps> = ({ fillColor = "#213F7D" }) => {
  return (
    <svg
      width="16"
      height="16"
    ...
    >
      <g id="coins-solid 1" clipPath="url(#clip0_117193_206)">
        <path
          id="Vector"
